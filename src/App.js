  ...
  return(// Padronizando Square como um botão
    <div> {/* Criando GRIDS por Div para o jogo da velha */}
      <div> {/* Números de Array em squares */}
        <Square valor={squares[0] onSquareClick={handleClick(1)} />
        <Square valor={squares[1] onSquareClick={handleClick(2)}} />
        <Square valor={squares[2] onSquareClick={handleClick(3)}} />
      </div>
      <div>
